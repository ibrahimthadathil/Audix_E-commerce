...
admin_routers.get(
  "/productsAdd",
  admin_auth.islogin,
  product_controll.loadAddproduct
);
...
admin_routers.get(
  "/editProduct",
  admin_auth.islogin,
  product_controll.loadeditProduct
);
...
admin_routers.get(
  "/dashboard",
  admin_auth.islogin,
  dashboard_controller.loadDashboard
);
